...
export default function Hero() {
  return (
    <div id="hero" className="hero w-screen h-screen bg-base-200 relative">
      <div>
        <div className="hero-content flex-col justify-center items-center md:flex-row">
          <div className="flex flex-col text-center md:text-left order-1 md:order-2">
            ...
            <p id="desc" className="py-6 text-xl">
              I&apos;m a developer. Also a musician. Also a chef. Oh yea I
              almost forget I was also an accountant at one point. I love my dog
              and watching Premier League soccer (or football for the folks
              outside the US).
            </p>
          </div>
          <Image
